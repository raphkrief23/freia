...
const schedule = [
  ...
  { day: "Mardi", hours: "19h30 – 20h45" },
  { day: "Mercredi", hours: "12h00 – 13h30 / 19h30 – 20h45" },
  { day: "Jeudi", hours: "12h00 – 13h30 / 19h30 – 20h45" },
  { day: "Vendredi", hours: "12h00 – 13h30 / 19h30 – 20h45" },
  { day: "Samedi", hours: "19h30 – 00h00" },
  { day: "Dimanche", hours: "Fermé" },
];

const MAPS_EMBED_URL =
  "https://maps.google.com/maps?q=47.2167031,-1.536549&z=17&output=embed";
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          >
            ...
            <div>
              ...
              <a
                href="mailto:contact@22-bd-de-berlin.fr"
                className="text-primary font-body tracking-wide hover:text-terracotta hover:tracking-wider transition-all duration-300"
              >
                contact@22-bd-de-berlin.fr
              </a>
            </div>
          </div>
          <div
